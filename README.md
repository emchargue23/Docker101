...
To operate this app, you must begin by building the container. To do this, you can use this command:
  
  `docker build -t getting-started .`

Next, you must start the container. To do this, you can use this command:
